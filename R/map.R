...
#'
#' @param data data
#' @param map a list of the coordinates of region border
#' @param cutpoints cuts for data scale
#' @param autoscale scale data to [0,1]
#' @param legend plot a legend
#' @param append add map to existing plot
#'
#' @export
#'
#' @examples

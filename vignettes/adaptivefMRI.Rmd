...
X <- auditory.hrf
Y <- new$data
hyper<-list("sigma2.a"=1,"sigma2.b"=1,"tau.a"=0.001,"tau.b"=1)
mcmc<-list("iterations"=600,"thin"=1,"burnin"=100)
options=list("tau"=TRUE,"sigma2"=FALSE,"print.time"=FALSE)
...
options2=list("tau"=rep(TRUE,2),"sigma2"=FALSE,"print.time"=FALSE)
